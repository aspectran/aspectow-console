...
public class AboutMe {
    ...
    static {
        ...
        if (pkg != null && "The Aspectran Project".equals(pkg.getImplementationVendor()) &&
            ...
            VERSION = System.getProperty("aspectow.console.version", "1.0.x");
        }
    ...
    /**
     * Prints the Aspectran and the Aspectow Management Console versions and
     * system information to the specified {@link PrintStream}.
    ...
    /**
     * Prints the Aspectran and the Aspectow Management Console versions and
     * system information in a pretty format to {@link System#out}.
